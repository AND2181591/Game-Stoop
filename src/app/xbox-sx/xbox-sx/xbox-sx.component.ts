...
import { XBOX_SERIES_X_ID } from 'src/app/constants/api.constants';
...
export class XboxSXComponent implements OnInit, OnDestroy {
  ...
  public fetchGames(): void {
    this._gameService.fetchGames(PLATFORM_PAGE_LIMIT, XBOX_SERIES_X_ID).pipe( takeUntil(this._subscriptionKiller$) ).subscribe(response => {
